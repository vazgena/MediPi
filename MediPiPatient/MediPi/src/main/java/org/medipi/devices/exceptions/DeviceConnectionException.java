...
public class DeviceConnectionException extends RuntimeException {
	 ...
	 */
	public DeviceConnectionException(final String message) {
		super(message);
	}
	 ...
	 */
	public DeviceConnectionException(final String message, final Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause the cause
	 */
	public DeviceConnectionException(final Throwable cause) {
		super(cause);
	}
}
