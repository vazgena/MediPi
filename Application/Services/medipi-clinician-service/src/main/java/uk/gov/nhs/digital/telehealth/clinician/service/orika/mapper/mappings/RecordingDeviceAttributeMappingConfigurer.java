...
@Component
public class RecordingDeviceAttributeMappingConfigurer implements MappingConfigurer {
	...
	public void configure(final MapperFactory factory) {
		...
		factory.classMap(RecordingDeviceAttributeMaster.class, RecordingDeviceAttribute.class)
		.byDefault()
		//@formatter:on
		.register();
	}
