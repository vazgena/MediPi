...
/**
 * Class to map data field names in the PatientDownloadable class in order
 ...
 */
@Component
public class PatientDownloadableMappingConfigurer implements MappingConfigurer {

	@Override
	public void configure(final MapperFactory factory) {
		factory.classMap(PatientDownloadable.class, DownloadableDO.class)
