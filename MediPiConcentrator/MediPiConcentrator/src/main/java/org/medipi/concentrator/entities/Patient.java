...
@Table(name = "patient")
@NamedQueries({
    @NamedQuery(name = "Patient.findByGroup", query = "SELECT p FROM Patient p WHERE p.patientGroupUuid.patientGroupUuid = :patientGroupUuid"),
...
public class Patient implements Serializable {
    ...
    @OneToMany(mappedBy = "patientUuid")
    ...
    public String toString() {
        return "org.medipi.concentrator.entities.Patient[ patientUuid=" + patientUuid + " ]";
    }
