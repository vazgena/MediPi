...
/**
 * Class to map data field names in the AllHardwareDownloadable class in order
 ...
 */
@Component
public class AllHardwareDownloadableMappingConfigurer implements MappingConfigurer {


    @Override
    public void configure(final MapperFactory factory) {
        factory.classMap(AllHardwareDownloadable.class, DownloadableDO.class)
