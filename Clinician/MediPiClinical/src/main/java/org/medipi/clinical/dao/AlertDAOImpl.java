...
public class AlertDAOImpl extends GenericDAOImpl<Alert> implements AlertDAO {
    @Override
    public List<Alert> findByNullTransmitSuccessDate(int maxRetries) {
        return this.getEntityManager().createNamedQuery("Alert.findByNullTransmitSuccessDate", Alert.class)
